...
const MOCK_OPPORTUNITIES: readonly Omit<Opportunity, "candidate_id" | "lead_id">[] = [
  {
    ...
    buyer: {
      ...
      confidence: 0.95,
      full_name: "Jordan Ferreira",
      title: "Head of Operations",
      email: "jordan@northwindfitness.example",
    ...
    verified_facts: {
      ...
      business_description:
        "A demo reading, not a real page fetch — mock mode has no Firecrawl call behind it.",
      industry_category: "fitness",
      customer_type: "b2c",
      multi_location_signal: true,
      operational_complexity_signal: true,
      employee_size_clue: "a multi-site regional operator",
      products_services: ["gym memberships", "personal training"],
      geography_clue: "Australia",
  ...
  },
  {
    ...
    verified_facts: {
      ...
      customer_type: "b2b",
      multi_location_signal: null,
      operational_complexity_signal: true,
      employee_size_clue: "an established distributor",
      products_services: ["supplement distribution"],
      geography_clue: "Australia",
      reasoning: "Fixed demo content — mock mode never fetches a real website.",
    },
    website_verified_at: new Date().toISOString(),
  ...
  },
  {
    ...
    verified_facts: {
      ...
      business_description: "A demo reading — mock mode never fetches a real website.",
      industry_category: "fitness",
      customer_type: "b2c",
      multi_location_signal: false,
      operational_complexity_signal: false,
      employee_size_clue: "a solo practice",
      products_services: [],
      geography_clue: "Australia",
...
function mockFunnel(finalCount: number) {
  return {
    ...
    research_calls: 4,
    buyer_lookup_eligible: 5,
    buyer_lookups: 3,
    buyer_found: 2,
    buyer_email_found: 1,
    final_opportunities: finalCount,
    final_contactable_opportunities: 1,
    llm_calls: 2,
    llm_cost_usd: "0.0000",
    provider_calls: 15,
    provider_cost_usd: "0.0000",
    website_calls: 8,
    website_cost_usd: "0.0000",
  };
}
