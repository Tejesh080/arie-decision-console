 ...
 *
 * "Your recent runs" below is *not* an auth-gated dashboard: it reads
 * `localStorage`, so it renders identically for a signed-in visitor and a
 * signed-out one — the whole point is that a stranger trying the public demo
 * can find their way back to what they ran, with no account required.
 */
